...
define dso_local i32 @_Z5test2v.stub() local_unnamed_addr #0 section ".qbbs_text" {
entry:
  ret i32 0
}
...
; CHECK:         .globl  _Z5test2v.stub          // -- Begin function _Z5test2v.stub
; CHECK:         .type   _Z5test2v.stub,@function
; CHECK: _Z5test2v.stub:                         // @_Z5test2v.stub
; CHECK: // %bb.0:                               // %entry
; CHECK:         return
; CHECK: .Lfunc_end0:
; CHECK:         .size   _Z5test2v.stub, .Lfunc_end0-_Z5test2v.stub
; CHECK:                                         // -- End function
